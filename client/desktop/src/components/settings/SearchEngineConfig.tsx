  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
        <div>
          <span className="settings-label" style={{ fontSize: 13 }}>{provider.label}</span>
          <div className="settings-desc" style={{ fontSize: 11 }}>{provider.description}</div>
        </div>
        <span style={{
          display: 'inline-flex',
          alignItems: 'center',
          ...
          borderRadius: 9999,
          fontSize: 11,
          background: hasKey ? 'rgba(80,227,194,0.12)' : 'rgba(128,128,128,0.1)',
          color: hasKey ? 'var(--color-secondary)' : 'var(--text-secondary)',
          border: `1px solid ${hasKey ? 'rgba(80,227,194,0.3)' : 'rgba(128,128,128,0.2)'}`,
        }}>
...
export default function SearchEngineConfig() {
  return (
